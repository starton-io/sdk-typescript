...
/** @internal */
export const DatabaseDuplicate$inboundSchema: z.ZodType<
  DatabaseDuplicate,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasDATABASEDUPLICATEContext$inboundSchema),
  ).optional(),
  errorCode: z.string().default("DATABASE_DUPLICATE"),
  message: z.string().default(
    "Duplicate conflict when saving this entity to the datbase.",
  ),
  path: z.string(),
...
export const DatabaseDuplicate$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  DatabaseDuplicate
> = z.instanceof(DatabaseDuplicate)
  .transform(v => v.data$)
  .pipe(
    z.object({
      ...
      context: z.nullable(
        z.lazy(() => SchemasDATABASEDUPLICATEContext$outboundSchema),
      ).optional(),
      errorCode: z.string().default("DATABASE_DUPLICATE"),
      message: z.string().default(
        "Duplicate conflict when saving this entity to the datbase.",
