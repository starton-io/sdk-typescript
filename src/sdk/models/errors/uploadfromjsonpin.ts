...
/** @internal */
export type UploadFromJsonPinIpfsResponseBody$Outbound = MaximumStorageReached$Outbound;
...
export namespace UploadFromJsonPinIpfsResponseBody$ {
    ...
    export const outboundSchema = UploadFromJsonPinIpfsResponseBody$outboundSchema;
...
/** @internal */
export type UploadFromJsonPinResponseBody$Outbound = BadRequestException$Outbound;
