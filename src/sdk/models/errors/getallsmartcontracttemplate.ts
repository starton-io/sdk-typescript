...
/** @internal */
export type GetAllSmartContractTemplateResponseBody$Outbound = BadRequestException$Outbound;
...
export namespace GetAllSmartContractTemplateResponseBody$ {
    ...
    export const inboundSchema = GetAllSmartContractTemplateResponseBody$inboundSchema;
    /** @deprecated use `GetAllSmartContractTemplateResponseBody$outboundSchema` instead. */
    export const outboundSchema = GetAllSmartContractTemplateResponseBody$outboundSchema;
