...
/** @internal */
export const GetAvailableFunctionsSmartContractSmartContractManagementResponseResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const GetAvailableFunctionsSmartContractSmartContractManagementResponseResponseBody$outboundSchema: z.ZodType<
...
/** @internal */
export const GetAvailableFunctionsSmartContractSmartContractManagementResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const GetAvailableFunctionsSmartContractSmartContractManagementResponseBody$outboundSchema: z.ZodType<
...
/** @internal */
export const GetAvailableFunctionsSmartContractResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const GetAvailableFunctionsSmartContractResponseBody$outboundSchema: z.ZodType<
...
export namespace GetAvailableFunctionsSmartContractResponseBody$ {
    ...
    export const inboundSchema = GetAvailableFunctionsSmartContractResponseBody$inboundSchema;
    /** @deprecated use `GetAvailableFunctionsSmartContractResponseBody$outboundSchema` instead. */
    export const outboundSchema = GetAvailableFunctionsSmartContractResponseBody$outboundSchema;
    /** @deprecated use `GetAvailableFunctionsSmartContractResponseBody$Outbound` instead. */
    export type Outbound = GetAvailableFunctionsSmartContractResponseBody$Outbound;
}
