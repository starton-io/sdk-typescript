...
/** @internal */
export const SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$inboundSchema:
  z.ZodType<
...
/** @internal */
export const SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$outboundSchema:
  z.ZodType<
...
export namespace SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$ {
  ...
  export const inboundSchema =
    SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$inboundSchema;
...
export function schemasREPLACEMENTGASPRICEUNDERPRICEDContextToJSON(
  schemasREPLACEMENTGASPRICEUNDERPRICEDContext:
    SchemasREPLACEMENTGASPRICEUNDERPRICEDContext,
): string {
  return JSON.stringify(
    SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$outboundSchema.parse(
      schemasREPLACEMENTGASPRICEUNDERPRICEDContext,
    ),
  );
}

export function schemasREPLACEMENTGASPRICEUNDERPRICEDContextFromJSON(
  jsonString: string,
): SafeParseResult<
  SchemasREPLACEMENTGASPRICEUNDERPRICEDContext,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      SchemasREPLACEMENTGASPRICEUNDERPRICEDContext$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'SchemasREPLACEMENTGASPRICEUNDERPRICEDContext' from JSON`,
  );
}
...
export const ReplacementGasPriceUnderpriced$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  ReplacementGasPriceUnderpriced
> = z.instanceof(ReplacementGasPriceUnderpriced)
  .transform(v => v.data$)
  .pipe(
    z.object({
