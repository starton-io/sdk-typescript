...
export namespace SchemasSERVERNOTRESPONDINGContext$ {
  ...
  export const outboundSchema =
    SchemasSERVERNOTRESPONDINGContext$outboundSchema;
...
export function schemasSERVERNOTRESPONDINGContextToJSON(
  schemasSERVERNOTRESPONDINGContext: SchemasSERVERNOTRESPONDINGContext,
): string {
  return JSON.stringify(
    SchemasSERVERNOTRESPONDINGContext$outboundSchema.parse(
      schemasSERVERNOTRESPONDINGContext,
    ),
  );
}

export function schemasSERVERNOTRESPONDINGContextFromJSON(
  jsonString: string,
): SafeParseResult<SchemasSERVERNOTRESPONDINGContext, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SchemasSERVERNOTRESPONDINGContext$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SchemasSERVERNOTRESPONDINGContext' from JSON`,
  );
}
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasSERVERNOTRESPONDINGContext$inboundSchema),
  ).optional(),
  errorCode: z.string().default("SERVER_NOT_RESPONDING"),
  message: z.string().default(
    "Your server that receive webhook is not responding.",
  ),
  path: z.string(),
...
export const ServerNotResponding$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  ServerNotResponding
> = z.instanceof(ServerNotResponding)
  .transform(v => v.data$)
  .pipe(
    z.object({
      ...
      context: z.nullable(
        z.lazy(() => SchemasSERVERNOTRESPONDINGContext$outboundSchema),
      ).optional(),
      errorCode: z.string().default("SERVER_NOT_RESPONDING"),
      message: z.string().default(
        "Your server that receive webhook is not responding.",
