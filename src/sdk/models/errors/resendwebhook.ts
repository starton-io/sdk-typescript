...
/** @internal */
export type ResendWebhookWebhookResponseResponseBody$Outbound = CouldNotResendWebhook$Outbound;
...
export namespace ResendWebhookWebhookResponseResponseBody$ {
    ...
    export const inboundSchema = ResendWebhookWebhookResponseResponseBody$inboundSchema;
    /** @deprecated use `ResendWebhookWebhookResponseResponseBody$outboundSchema` instead. */
    export const outboundSchema = ResendWebhookWebhookResponseResponseBody$outboundSchema;
...
/** @internal */
export type ResendWebhookWebhookResponseBody$Outbound = CouldNotFindResource$Outbound;
