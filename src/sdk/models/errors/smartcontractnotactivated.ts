...
export namespace SchemasSMARTCONTRACTNOTACTIVATEDContext$ {
  ...
  export const inboundSchema =
    SchemasSMARTCONTRACTNOTACTIVATEDContext$inboundSchema;
  /** @deprecated use `SchemasSMARTCONTRACTNOTACTIVATEDContext$outboundSchema` instead. */
  export const outboundSchema =
    SchemasSMARTCONTRACTNOTACTIVATEDContext$outboundSchema;
...
export function schemasSMARTCONTRACTNOTACTIVATEDContextToJSON(
  schemasSMARTCONTRACTNOTACTIVATEDContext:
    SchemasSMARTCONTRACTNOTACTIVATEDContext,
): string {
  return JSON.stringify(
    SchemasSMARTCONTRACTNOTACTIVATEDContext$outboundSchema.parse(
      schemasSMARTCONTRACTNOTACTIVATEDContext,
    ),
  );
}

export function schemasSMARTCONTRACTNOTACTIVATEDContextFromJSON(
  jsonString: string,
): SafeParseResult<
  SchemasSMARTCONTRACTNOTACTIVATEDContext,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      SchemasSMARTCONTRACTNOTACTIVATEDContext$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'SchemasSMARTCONTRACTNOTACTIVATEDContext' from JSON`,
  );
}
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasSMARTCONTRACTNOTACTIVATEDContext$inboundSchema),
  ).optional(),
...
export const SmartContractNotActivated$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  SmartContractNotActivated
> = z.instanceof(SmartContractNotActivated)
  .transform(v => v.data$)
  .pipe(
    z.object({
