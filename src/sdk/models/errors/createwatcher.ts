...
/** @internal */
export const CreateWatcherMonitorResponse500ResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const CreateWatcherMonitorResponse500ResponseBody$outboundSchema: z.ZodType<
...
export namespace CreateWatcherMonitorResponse500ResponseBody$ {
    ...
    export const inboundSchema = CreateWatcherMonitorResponse500ResponseBody$inboundSchema;
    /** @deprecated use `CreateWatcherMonitorResponse500ResponseBody$outboundSchema` instead. */
    export const outboundSchema = CreateWatcherMonitorResponse500ResponseBody$outboundSchema;
...
/** @internal */
export type CreateWatcherMonitorResponseResponseBody$Outbound = ServerNotResponding$Outbound;
...
export namespace CreateWatcherMonitorResponseResponseBody$ {
    ...
    export const inboundSchema = CreateWatcherMonitorResponseResponseBody$inboundSchema;
    /** @deprecated use `CreateWatcherMonitorResponseResponseBody$outboundSchema` instead. */
    export const outboundSchema = CreateWatcherMonitorResponseResponseBody$outboundSchema;
...
/** @internal */
export type CreateWatcherMonitorResponseBody$Outbound = DatabaseDuplicate$Outbound;
