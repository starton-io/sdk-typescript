...
export namespace SchemasCOULDNOTCANCELWEBHOOKContext$ {
  ...
  export const inboundSchema =
    SchemasCOULDNOTCANCELWEBHOOKContext$inboundSchema;
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasCOULDNOTCANCELWEBHOOKContext$inboundSchema),
  ).optional(),
...
export const CouldNotCancelWebhook$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  CouldNotCancelWebhook
> = z.instanceof(CouldNotCancelWebhook)
  .transform(v => v.data$)
  .pipe(
    z.object({
      ...
      context: z.nullable(
        z.lazy(() => SchemasCOULDNOTCANCELWEBHOOKContext$outboundSchema),
      ).optional(),
      errorCode: z.string().default("COULD_NOT_CANCEL_WEBHOOK"),
      message: z.string().default("Could not cancel webhook."),
      path: z.string(),
