...
export namespace SchemasCONTRACTNOTYETDEPLOYEDContext$ {
  ...
  export const inboundSchema =
    SchemasCONTRACTNOTYETDEPLOYEDContext$inboundSchema;
  /** @deprecated use `SchemasCONTRACTNOTYETDEPLOYEDContext$outboundSchema` instead. */
  export const outboundSchema =
    SchemasCONTRACTNOTYETDEPLOYEDContext$outboundSchema;
...
export function schemasCONTRACTNOTYETDEPLOYEDContextToJSON(
  schemasCONTRACTNOTYETDEPLOYEDContext: SchemasCONTRACTNOTYETDEPLOYEDContext,
): string {
  return JSON.stringify(
    SchemasCONTRACTNOTYETDEPLOYEDContext$outboundSchema.parse(
      schemasCONTRACTNOTYETDEPLOYEDContext,
    ),
  );
}

export function schemasCONTRACTNOTYETDEPLOYEDContextFromJSON(
  jsonString: string,
): SafeParseResult<SchemasCONTRACTNOTYETDEPLOYEDContext, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      SchemasCONTRACTNOTYETDEPLOYEDContext$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SchemasCONTRACTNOTYETDEPLOYEDContext' from JSON`,
  );
}
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasCONTRACTNOTYETDEPLOYEDContext$inboundSchema),
  ).optional(),
  errorCode: z.string().default("CONTRACT_NOT_YET_DEPLOYED"),
  message: z.string().default(
    "Smart contract is not deployed on the blockchain yet.",
  ),
  path: z.string(),
...
export const ContractNotYetDeployed$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  ContractNotYetDeployed
> = z.instanceof(ContractNotYetDeployed)
  .transform(v => v.data$)
  .pipe(
    z.object({
