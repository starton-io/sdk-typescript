...
export namespace SchemasUNEXPECTEDARGUMENTContext$ {
    ...
    export const inboundSchema: z.ZodType<SchemasUNEXPECTEDARGUMENTContext, z.ZodTypeDef, Inbound> =
        z.object({});
...
export namespace UnexpectedArgument$ {
    export type Inbound = {
        ...
        RawResponse2?: Response | undefined;
        RawResponse3?: Response | undefined;
        context?: SchemasUNEXPECTEDARGUMENTContext$.Inbound | undefined;
