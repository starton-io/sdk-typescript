...
export namespace ImportExistingSmartContractResponseBody$ {
    ...
    export const inboundSchema = ImportExistingSmartContractResponseBody$inboundSchema;
    /** @deprecated use `ImportExistingSmartContractResponseBody$outboundSchema` instead. */
    export const outboundSchema = ImportExistingSmartContractResponseBody$outboundSchema;
