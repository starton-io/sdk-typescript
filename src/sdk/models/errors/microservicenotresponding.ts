...
export namespace SchemasMICROSERVICENOTRESPONDINGContext$ {
  ...
  export const inboundSchema =
    SchemasMICROSERVICENOTRESPONDINGContext$inboundSchema;
  /** @deprecated use `SchemasMICROSERVICENOTRESPONDINGContext$outboundSchema` instead. */
  export const outboundSchema =
    SchemasMICROSERVICENOTRESPONDINGContext$outboundSchema;
...
export function schemasMICROSERVICENOTRESPONDINGContextToJSON(
  schemasMICROSERVICENOTRESPONDINGContext:
    SchemasMICROSERVICENOTRESPONDINGContext,
): string {
  return JSON.stringify(
    SchemasMICROSERVICENOTRESPONDINGContext$outboundSchema.parse(
      schemasMICROSERVICENOTRESPONDINGContext,
    ),
  );
}

export function schemasMICROSERVICENOTRESPONDINGContextFromJSON(
  jsonString: string,
): SafeParseResult<
  SchemasMICROSERVICENOTRESPONDINGContext,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      SchemasMICROSERVICENOTRESPONDINGContext$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'SchemasMICROSERVICENOTRESPONDINGContext' from JSON`,
  );
}
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasMICROSERVICENOTRESPONDINGContext$inboundSchema),
  ).optional(),
...
export const MicroserviceNotResponding$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  MicroserviceNotResponding
> = z.instanceof(MicroserviceNotResponding)
  .transform(v => v.data$)
  .pipe(
    z.object({
