...
/** @internal */
export const DeleteProjectMemberProjectMemberResponseResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export const DeleteProjectMemberProjectMemberResponseResponseBody$outboundSchema: z.ZodType<
...
export namespace DeleteProjectMemberProjectMemberResponseResponseBody$ {
    ...
    export const inboundSchema = DeleteProjectMemberProjectMemberResponseResponseBody$inboundSchema;
    ...
    export type Outbound = DeleteProjectMemberProjectMemberResponseResponseBody$Outbound;
}

/** @internal */
export const DeleteProjectMemberProjectMemberResponseBody$inboundSchema: z.ZodType<
...
/** @internal */
export type DeleteProjectMemberProjectMemberResponseBody$Outbound = CouldNotFindResource$Outbound;

/** @internal */
export const DeleteProjectMemberProjectMemberResponseBody$outboundSchema: z.ZodType<
...
export namespace DeleteProjectMemberProjectMemberResponseBody$ {
    ...
    export const inboundSchema = DeleteProjectMemberProjectMemberResponseBody$inboundSchema;
    /** @deprecated use `DeleteProjectMemberProjectMemberResponseBody$outboundSchema` instead. */
    export const outboundSchema = DeleteProjectMemberProjectMemberResponseBody$outboundSchema;
...
/** @internal */
export type DeleteProjectMemberResponseBody$Outbound = BadRequestException$Outbound;
