...
export namespace SchemasCOULDNOTRESENDWEBHOOKContext$ {
  ...
  export const inboundSchema =
    SchemasCOULDNOTRESENDWEBHOOKContext$inboundSchema;
...
> = z.object({
  ...
  context: z.nullable(
    z.lazy(() => SchemasCOULDNOTRESENDWEBHOOKContext$inboundSchema),
  ).optional(),
...
export const CouldNotResendWebhook$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  CouldNotResendWebhook
> = z.instanceof(CouldNotResendWebhook)
  .transform(v => v.data$)
  .pipe(
    z.object({
      ...
      context: z.nullable(
        z.lazy(() => SchemasCOULDNOTRESENDWEBHOOKContext$outboundSchema),
      ).optional(),
      errorCode: z.string().default("COULD_NOT_RESEND_WEBHOOK"),
      message: z.string().default("Could not resend webhook."),
      path: z.string(),
