...
/** @internal */
export const UploadFromJsonPinResponse$inboundSchema: z.ZodType<
...
/** @internal */
export type UploadFromJsonPinResponse$Outbound = {
    ContentType: string;
...
/** @internal */
export const UploadFromJsonPinResponse$outboundSchema: z.ZodType<
    UploadFromJsonPinResponse$Outbound,
    z.ZodTypeDef,
    UploadFromJsonPinResponse
> = z
    .object({
...
export namespace UploadFromJsonPinResponse$ {
    /** @deprecated use `UploadFromJsonPinResponse$inboundSchema` instead. */
    export const inboundSchema = UploadFromJsonPinResponse$inboundSchema;
    /** @deprecated use `UploadFromJsonPinResponse$outboundSchema` instead. */
