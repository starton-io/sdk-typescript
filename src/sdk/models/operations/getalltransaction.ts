...
> = z.object({
  ...
  fromDate: z.string().datetime({ offset: true }).transform(v => new Date(v))
    .optional(),
...
> = z.object({
  from: z.string().optional(),
  fromDate: z.date().transform(v => v.toISOString()).optional(),
  limit: z.number().int().default(100),
  network: z.string().optional(),
  page: z.number().int().optional(),
...
export namespace GetAllTransactionTransactionPaginated$ {
  ...
  export const inboundSchema =
    GetAllTransactionTransactionPaginated$inboundSchema;
