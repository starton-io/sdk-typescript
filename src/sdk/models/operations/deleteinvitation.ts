...
export namespace DeleteInvitationRequest$ {
    export const inboundSchema: z.ZodType<DeleteInvitationRequest, z.ZodTypeDef, unknown> =
        z.object({
            id: z.string(),
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeleteInvitationRequest> =
        z.object({
            id: z.string(),
        });
}
