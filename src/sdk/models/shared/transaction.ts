...
/** @internal */
export const TransactionSpeed$inboundSchema: z.ZodNativeEnum<
  typeof TransactionSpeed
> = z.nativeEnum(TransactionSpeed);

/** @internal */
export const TransactionSpeed$outboundSchema: z.ZodNativeEnum<
  typeof TransactionSpeed
...
/** @internal */
export const TransactionState$inboundSchema: z.ZodNativeEnum<
  typeof TransactionState
> = z.nativeEnum(TransactionState);

/** @internal */
export const TransactionState$outboundSchema: z.ZodNativeEnum<
  typeof TransactionState
...
> = z.object({
  ...
  metadata: z.nullable(z.lazy(() => TransactionMetadata$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  maxFeePerGas: z.nullable(z.string()).optional(),
  maxPriorityFeePerGas: z.nullable(z.string()).optional(),
  metadata: z.nullable(z.lazy(() => TransactionMetadata$outboundSchema))
    .optional(),
  ...
  parentTransaction: z.nullable(z.string()).optional(),
  projectId: z.string(),
  publishedDate: z.nullable(z.date().transform(v => v.toISOString()))
    .optional(),
  signedTransaction: z.nullable(z.string()).optional(),
  signerWallet: z.string(),
