...
import { TransactionLog, TransactionLog$ } from "./transactionlog.js";
...
export namespace TransactionSpeed$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TransactionSpeed> =
        z.nativeEnum(TransactionSpeed);
    export const outboundSchema: z.ZodNativeEnum<typeof TransactionSpeed> = inboundSchema;
}

/** @internal */
export namespace TransactionState$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TransactionState> =
        z.nativeEnum(TransactionState);
    export const outboundSchema: z.ZodNativeEnum<typeof TransactionState> = inboundSchema;
}

/** @internal */
export namespace TransactionStatus$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TransactionStatus> =
        z.nativeEnum(TransactionStatus);
    export const outboundSchema: z.ZodNativeEnum<typeof TransactionStatus> = inboundSchema;
}
