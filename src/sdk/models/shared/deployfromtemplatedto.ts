...
export namespace DeployFromTemplateDtoDeployMethod$ {
    ...
    export const outboundSchema = DeployFromTemplateDtoDeployMethod$outboundSchema;
}
...
> = z.object({
    ...
    templateId: z.string(),
    uiData: z.nullable(z.lazy(() => DeployFromTemplateDtoUiData$outboundSchema)).optional(),
    value: z.string().optional(),
});
