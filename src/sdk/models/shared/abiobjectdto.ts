...
/** @internal */
export const StateMutability$inboundSchema: z.ZodNativeEnum<typeof StateMutability> =
    z.nativeEnum(StateMutability);

/** @internal */
export const StateMutability$outboundSchema: z.ZodNativeEnum<typeof StateMutability> =
...
/** @internal */
export const AbiObjectDto$inboundSchema: z.ZodType<AbiObjectDto, z.ZodTypeDef, unknown> = z.object({
