...
import { AbiInputDto, AbiInputDto$ } from "./abiinputdto.js";
import { AbiOutputDto, AbiOutputDto$ } from "./abioutputdto.js";
...
export namespace StateMutability$ {
    export const inboundSchema: z.ZodNativeEnum<typeof StateMutability> =
        z.nativeEnum(StateMutability);
    export const outboundSchema: z.ZodNativeEnum<typeof StateMutability> = inboundSchema;
}
