...
/** @internal */
export const Credentials$inboundSchema: z.ZodType<Credentials, z.ZodTypeDef, unknown> = z.union([
    AwsKmsCredentialsDto$inboundSchema,
    VaultKmsCredentialsDto$inboundSchema,
]);

/** @internal */
export type Credentials$Outbound = AwsKmsCredentialsDto$Outbound | VaultKmsCredentialsDto$Outbound;
...
/** @internal */
export const CreateKmsDto$inboundSchema: z.ZodType<CreateKmsDto, z.ZodTypeDef, unknown> = z.object({
    credentials: z
