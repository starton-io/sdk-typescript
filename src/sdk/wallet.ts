...
export class Wallet extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(walletCreate(this, request, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(walletDelete(this, request, options));
    }
    ...
    async getAll(
        ...
        return unwrapResultIterator(walletGetAll(this, request, options));
    }
    ...
    async getOne(
        ...
        return unwrapAsync(walletGetOne(this, request, options));
    }
    ...
    async import(
        ...
        return unwrapAsync(walletImport(this, request, options));
    }
    ...
    async requestFaucet(
        ...
        return unwrapAsync(walletRequestFaucet(this, request, options));
    }
    ...
    async resyncNonce(
        ...
        return unwrapAsync(walletResyncNonce(this, request, options));
    }
    ...
    async sign(
        ...
        return unwrapAsync(walletSign(this, request, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(walletUpdate(this, request, options));
    }
}
