...
export class Monitor extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(monitorCreate(this, request, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(monitorDelete(this, request, options));
    }
    ...
    async getAll(
        ...
        return unwrapResultIterator(monitorGetAll(this, request, options));
    }
    ...
    async getAllEvents(
        ...
        return unwrapResultIterator(monitorGetAllEvents(this, request, options));
    }
    ...
    async getOne(
        ...
        return unwrapAsync(monitorGetOne(this, request, options));
    }
    ...
    async getOneEvent(
        ...
        return unwrapAsync(monitorGetOneEvent(this, request, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(monitorUpdate(this, request, options));
    }
}
