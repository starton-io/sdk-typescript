...
export class Ipfs extends ClientSDK {
    ...
    async delete(
        ...
        const [result$] = await m$.match<
            operations.DeletePinResponse,
            | errors.DeletePinResponseBody
            | errors.DeletePinIpfsResponseBody
            | SDKError
            | SDKValidationError
        >(
            m$.json(200, operations.DeletePinResponse$inboundSchema, { key: "boolean" }),
            m$.jsonErr(400, errors.DeletePinResponseBody$inboundSchema),
            m$.jsonErr(404, errors.DeletePinIpfsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
    ...
    async getAll(
        ...
        const [result$, raw$] = await m$.match<
            ...
            errors.GetAllPinResponseBody | SDKError | SDKValidationError
        >(
            m$.json(200, operations.GetAllPinResponse$inboundSchema, { key: "PinPaginated" }),
    ...
    async getStorageUsed(options?: RequestOptions): Promise<operations.GetStorageUsedPinResponse> {
        const path$ = pathToFunc("/v3/ipfs/storage-used")();
        ...
        const [result$] = await m$.match<
            operations.GetStorageUsedPinResponse,
            errors.GetStorageUsedPinResponseBody | SDKError | SDKValidationError
        >(
            m$.json(200, operations.GetStorageUsedPinResponse$inboundSchema, {
                key: "StorageUsed",
            }),
            m$.jsonErr(400, errors.GetStorageUsedPinResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });
    ...
    async pinExistingFile(
        ...
        const [result$] = await m$.match<
            operations.CreatePinResponse,
            | errors.CreatePinResponseBody
            | errors.CreatePinIpfsResponseBody
            | SDKError
            | SDKValidationError
        >(
    ...
    async uploadFolder(
        ...
        const [result$] = await m$.match<
            ...
            | SDKValidationError
        >(
            m$.json(201, operations.UploadFromFolderPinResponse$inboundSchema, { key: "Pin" }),
    ...
    async uploadJson(
        ...
        const [result$] = await m$.match<
            ...
            | SDKValidationError
        >(
            m$.json(201, operations.UploadFromJsonPinResponse$inboundSchema, { key: "Pin" }),
