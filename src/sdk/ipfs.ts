...
export class Ipfs extends ClientSDK {
    ...
    async delete(
        ...
        return unwrapAsync(ipfsDelete(this, request, options));
    }
    ...
    async getAll(
        ...
        return unwrapResultIterator(ipfsGetAll(this, request, options));
    }
    ...
    async getOne(
        ...
        return unwrapAsync(ipfsGetOne(this, request, options));
    }
    ...
    async getStorageUsed(options?: RequestOptions): Promise<operations.GetStorageUsedPinResponse> {
        return unwrapAsync(ipfsGetStorageUsed(this, options));
    }
    ...
    async pinExistingFile(
        ...
        return unwrapAsync(ipfsPinExistingFile(this, request, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(ipfsUpdate(this, request, options));
    }
    ...
    async uploadFile(
        ...
        return unwrapAsync(ipfsUploadFile(this, request, options));
    }
    ...
    async uploadFolder(
        ...
        return unwrapAsync(ipfsUploadFolder(this, request, options));
    }
    ...
    async uploadJson(
        ...
        return unwrapAsync(ipfsUploadJson(this, request, options));
    }
}
