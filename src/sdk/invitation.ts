...
export class Invitation extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(projectMemberInvitationCreate(this, request, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(projectMemberInvitationDelete(this, request, options));
    }
    ...
    async getAll(
        ...
        return unwrapResultIterator(projectMemberInvitationGetAll(this, request, options));
    }
}
