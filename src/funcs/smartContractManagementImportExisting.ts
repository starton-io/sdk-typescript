 ...
 */
export async function smartContractManagementImportExisting(
  client: StartonCore,
  ...
  Result<
    ...
    | errors.ImportExistingSmartContractResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.ImportExistingSmartContractResponseBody$inboundSchema,
    ),
    M.fail(["4XX", "5XX"]),
