 ...
 */
export async function transactionManagerGetAll(
  client$: StartonCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.GetAllTransactionResponseBody
      | SDKError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.GetAllTransactionRequest$outboundSchema.parse(value$),
