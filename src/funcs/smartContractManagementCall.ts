...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, operations.CallSmartContractResponse$inboundSchema, { key: "Transaction" }),
        m$.jsonErr(400, errors.CallSmartContractResponseBody$inboundSchema),
        m$.jsonErr(404, errors.CallSmartContractSmartContractManagementResponseBody$inboundSchema),
        m$.jsonErr(
            422,
