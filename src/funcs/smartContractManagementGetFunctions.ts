...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAvailableFunctionsSmartContractRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetAvailableFunctionsSmartContractResponse$inboundSchema,
      { key: "AvailableFunctions" },
    ),
    M.jsonErr(
      400,
      errors.GetAvailableFunctionsSmartContractResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors
